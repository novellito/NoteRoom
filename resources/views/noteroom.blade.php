  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-pills dropdown">
        <a class="nav-link dropdown" data-toggle="dropdown" href="#" role="button" href="#" aria-haspopup="true" aria-expanded="false">Home</a>
        <div class="dropdown-menu">
          <a class="dropdown-item" href="#">My Noterooms</a>
